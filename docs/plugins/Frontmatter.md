...
This plugin parses the frontmatter of the page using the [gray-matter](https://github.com/jonschlinkert/gray-matter) library. See [[authoring content#Syntax](../authoring%20content.md), [[Obsidian compatibility](../features/Obsidian%20compatibility.md) and [[OxHugo compatibility](../features/OxHugo%20compatibility.md) for more information.
