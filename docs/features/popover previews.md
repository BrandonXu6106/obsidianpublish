...
When [[creating components|creating your own components](../advanced/creating%20components.md), you can include this `popover-hint` class to also include it in the popover.
