...
Citation parsing is a functionality of the [[../plugins/Citations.md|Citation]] plugin. **This plugin is not enabled by default**. See the plugin page for customization options.
