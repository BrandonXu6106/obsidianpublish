...
regular Markdown via the [[../plugins/RoamFlavoredMarkdown.md]] plugin.
...
This functionality is provided by the [[../plugins/RoamFlavoredMarkdown.md]] plugin. See the plugin page for customization options.
