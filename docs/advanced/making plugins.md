...
- `BuildCtx` is defined in `quartz/ctx.ts`. It consists of
  - `argv`: The command line arguments passed to the Quartz [[../build.md]] command
  - `cfg`: The full Quartz [[../configuration.md]]
  - `allSlugs`: a list of all the valid content slugs (see [[paths.md]] for more information on what a slug is)
...
A good example of a transformer plugin that borrows from the `remark` and `rehype` ecosystems is the [[../plugins/Latex.md|Latex]] plugin:
