...
![[Franz Kafka#^6160dc|Franz Kafka]]
...
Again, borrowing words from [[Franz Kafka|Franz Kafka]]:
...
This uncertainty was an eternal [[The Sword of Damocles|sword of Damocles]] hanging over my head, never allowing me to enjoy the moments of normalcy and calm between fits of anger -- truly an unfairness for all parties.
...
Attempts at repair require a certain vulnerability that is always taken advantage of. How many times must one burn their hand to learn to not touch the fire? Time and time again, after each [[2022|successive failure]], I pull my hand back wincing in pain in the hopes that for once it will be different.
...
- Make [[50 pounds of pots|50 pounds of ceramics]]. Throw 40 cups, 20 bowls, and 20 plates.
