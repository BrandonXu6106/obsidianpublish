...
- Web3 lacks [infrastructure](infrastructure.md)
...
- [Decentralization](decentralization.md) is not always good. The more I get involved with the space, the more I am certain that the main value add of [blockchain](blockchain.md) and [web3](web3.md) is not decentralization but rather [interoperability](interoperability.md) and [transparency](transparency.md).
  - Decentralization also ends up making progress very difficult. See: [Vanilla Ice Cream effect](Vanilla%20Ice%20Cream%20effect.md)
...
- Blind [trust](trust.md). Crypto folks don't necessarily trust the people but some just blindly trust the medium. If people don't understand how the medium works to facilitate transactions, how can they trust it? Transparency also involves transparency into its inner workings.
...
- [Degraded Blockchain problem](Degraded%20Blockchain%20problem.md)
