...
An approach to the development of AI focused on statistical methods and [[connectionist networks]] like artificial [[neural networks|neural networks]]. Haugeland dubbed this approach to AI design New Fangled AI (NFAI).
...
NFAI is a very grab-bag term, it practically means anything that isn't [[GOFAI]].
