...
Main method of communication at the [Application Layer](Application%20Layer.md) for the web. A state-transfer protocol. Sometimes called the second waist of the Internet (after [[IP Address]])
