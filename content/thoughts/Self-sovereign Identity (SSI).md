...
Self-sovereign identity (SSI) is an approach to digital identity that gives individuals [[agency]] over their digital identities
...
In SSI systems, holders have control over unique identifiers (decentralized identifiers). These can be verified using [[encryption|encryption]] and anchored on some sort of distributed ledger (e.g. [[blockchain|blockchain]])
...
Mostly critiques about certain implementations of [[soulbound|SBTs]] or [[Verifiable Credential|VCs]] (which she refers to as Verifiable attestations)
