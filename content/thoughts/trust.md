...
Yet all of these theories share the presumption of agent-directedness or [intentionality](intentionality.md).

Related, [agential gullibility and the Extended mind Hypothesis](Extended%20Mind%20Hypothesis.md)
...
"Because [blockchain](blockchain.md)s allow us to define succinctly our shared truths, **and because the record itself is shared** across all participants, there is a whole new "trust space" we can explore, searching for more valuable kinds of transactions impossible within merely legal fictions."
