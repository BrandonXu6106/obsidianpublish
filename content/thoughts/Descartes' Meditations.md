...
Cartesian doubt refers to the opposite of [trust](trust.md) in Nguyen's sense
...
[Qualia](qualia.md) can only be perceived in a confused and obscure way, so if they are things, they must have small degree of reality as to originate unproblematically from the Meditator himself
...
2.  Necessary existence is a perfection. It is an existence where one depends only on [the self](the%20Self.md) for existence (similar to the concept of independent origination in [emptiness](emptiness.md)).
