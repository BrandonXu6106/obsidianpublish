...
- **user-centered design**: incorporating users heavily into the desing process (e.g. [double-diamond design](design%20requirements.md) and iterative design model)
