...
Rather than picking from fixed convolutions, we learn the elements of the filters. A convolution is a [[imaging#Linear Filters|linear filter]] that measures the effect one signal has on another signal.
