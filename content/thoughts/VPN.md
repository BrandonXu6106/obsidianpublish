...
![](content/recentnotes/images/VPN.jpeg)

VPN Encapsulation

- Virtual end points establish software association between them (e.g. [TCP](TCP.md) connection) usually referred to as a tunnel
