...
[[system model|System models](system%20model.md) for programming.

## Technical Dimensions of Programming Systems

[Source](https://tomasp.net/techdims/)

![[images/tech-dims.png|500]]

7 clusters

1. Interaction: how do users manifest their ideas, use the system to get a result, and generate new ideas in response?
   - How many layers of [[feedback loops](feedback%20loops.md) are present when translating a user's intention to getting a response?
   ...
   - See also: [[mental model](mental%20model.md), [[feedback loops#Interaction Design|feedback loops in interaction design](feedback%20loops.md)
...
3. Conceptual structure: how do the parts fit together?
   - [[composable.md|Composability]]: There exist building blocks which span a range of useful combinations. Composability is, in a sense, key to the notion of "programmability" and every programmable system will have some level of composability
   ...
   - Conceptual openness: can be seen as championing the values of *[[plurality.md|pluralism]]*, *compatibility*, or *conceptual openness* over conceptual integrity
...
5. [[complexity.md|Complexity]]: how does the system structure complexity and what level of detail is required?
   ...
   - Declarative vs imperative programming systems
     - [[declarative programming|Declarative programming](declarative%20programming.md) systems like SQL, Prolog or Datalog, the meaning of a program is still unambiguous, but it is not defined operationally—there is a (more or less deterministic) inference engine that solves the problem based on the provided description.
...
6. Errors: what does the system consider to be an error? How are they prevented and handled?
   ...
   - Normally, error detection occurs in the feedback loops that the system implements.
     ...
     - How does the system respond when an error is detected?
       - The system may try to automatically recover from the error as best as possible ([[CRDT.md|CRDTs]] take this approach)
       - The system may proceed as if the error did not happen
       - The system may ask a human to resolve the issue. This is common for errors that occur on a [[semantics.md|semantic]] level
7. Adoptability: how does the system facilitate or obstruct adoption by both individuals and communities?
   ...
   - See also: [[design goals](design%20goals.md), [[notation.md]]
