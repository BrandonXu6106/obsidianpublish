...
We store, access, and organize information through [information systems](information%20system.md).
...
The study of information in and of itself is a research area too, through and the [Information Professions](information%20professions.md)
...
Contrary to Marshall McLuhan’s famous phrase, "the medium is the message", it seems as if the vast majority of the power from information is derived from its meaning and [context](context.md) rather than its medium or method of transmission.
