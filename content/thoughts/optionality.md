...
As humans, we tend to love 'exploring' our possibilities more than 'exploiting' and diving deep/committing to what we already have -- we lean heavily toward explore in the [exploit explore](exploit%20explore.md) tradeoff curve.
...
Maybe why humans constantly chase [prestige](prestige.md): to keep doors open as a means of cross-disciplinary recognition.
