...
One thing that I still don't understand about blockchain is the 'trustless' aspect of blockchains. Blockchains are not 'trustless', rather it shifts the [trust](trust.md) balance away from trusting people and corporations to trusting an algorithm.[^1]
