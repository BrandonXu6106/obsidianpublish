...
Goals in the context of HCI are things that can be defined in a given [[context.md]], then evaluated.
...
5. [[affordance.md]]: attributes should obviously signal what they can use it for.
