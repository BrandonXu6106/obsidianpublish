...
> What if other objects like the Antikythera Mechanism have already been discovered and [[forgetting.md|forgotten]]? There may well be documented evidence of such finds somewhere in the world, in the vast archives of human research, scholarly and otherwise, but simply no way to search for them. Until now.
...
Are better tools for [collaborative thinking](../posts/aigc/collaborative-thinking.md) with [networked thought](../posts/readnotes/networked-thought.md) potential ways to counteract this? What about [[digital permanence|digital permanence](digital%20permanence.md)? How do we effectively [[search.md|search]] for information?
