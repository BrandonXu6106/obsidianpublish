...
from [Design Justice](Design%20Justice.md) and Friedman
...
3. Emergent Bias: may not have been biased given its original [context](context.md) of use or original user base but comes to exhibit bias when the context shifts or when new users arrive (e.g. responses to spam, content moderation, search suggestions)

Cathy O’Neil: algorithms are “opinions embedded in code” -- [artifacts do indeed have politics](Do%20Artifacts%20Have%20Politics.md)
