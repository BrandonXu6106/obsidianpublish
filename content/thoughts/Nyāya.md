...
Nyāya is a major proponent of [philosophical realism](philosophical%20realism.md) -- cognition is only possible because it is dependent on the objects in this world.

Nyāya adopts the Vaiśeṣika [[ontology.md|ontology]], which posits that seven different types of things:
...
Pramānas are means of knowledge and provide it through mode like perception, inference, and [testimony](testimony.md). The objects of knowledge are called 'knowables' (prameya).
...
Rational inquiry requires purpose. We do not doubt everything, lest we not [trust](trust.md) the ground beneath us. Debate must proceed based off of shared axioms.

Counter against the dream argument (perception of knowledge is akin to conception of objects in dreams) -- similar to [Descartes' Dream Argument](Descartes'%20Meditations.md)
...
- Error, [[seeing.md|seeing]] a post as a person or vice versa, occurs when their differences are elided while their similarities are grasped.
