...
## [Centralization](decentralization.md) of Content and Services
...
1. [Mangrove Theory of the Internet](Mangrove%20Theory%20of%20the%20Internet.md)
2. [Dark Forest Theory of the Internet](Dark%20Forest%20Theory%20of%20the%20Internet.md)
3. The Internet Is a Collective Hallucination ([digital permanence](digital%20permanence.md))
4. A [friction](friction.md)-ful Internet
5. [Moving Castles and Wizards](Moving%20Castles.md)

## Internet [Epistemology](epistemology.md)

On [epistemic authority](epistemic%20authority.md)
...
- post-truth?
  ...
  - product of low [trust](trust.md) and highly polarized information environment
  - information becomes fact
- see: [gate keeping](gate%20keeping.md)
...
This absence of central control, or even easy central monitoring, has long been celebrated as an instrument of grassroots [democracy](democracy.md) and freedom.
...
"It’s not trivial to [censor](censorship.md) a network as organic and decentralized as the internet. But more recently, these features have been understood to facilitate vectors for individual harassment and societal destabilization, with no easy gating points through which to remove or label malicious work not under the umbrellas of the major social-media platforms, or to quickly identify their sources."
...
Curious about how this relates to [ephemereal content](ephemereal%20content.md). Is moderation and managing rot thereby a form of [maintenance](creation%20vs%20maintenance.md)?
