...
Argument that rests on the ambiguity of what "[information](information.md)" is. For example, one can say that the programmed computer does not do information processesing, it only manipulates formal symbols.
