...
[Creation vs Maintenance](creation%20vs%20maintenance.md) view of developing AI:
...
For those of us who can just _not_ deal with race, or gender, or sexuality, we get to pass through these systems relatively unscathed. But for those of us who can't ignore those dimensions of who we are, those aspects of ourselves make us stick out. More examples in [Design Justice](Design%20Justice.md).

## [Utopia](utopia.md)

A utopia implies perfection and thus no feedback. ML models think they live in a perfect world unless told otherwise.

Related: [The ones who walk away from Omelas](The%20ones%20who%20walk%20away%20from%20Omelas.md)

## '[Truth](truth.md)' and [Feedback loops](feedback%20loops.md)

"Absurdity follows when algorithmic systems deny the people they mistreat the status to lodge complaints, let alone the power to repair, resist, or escape the world that these systems create." How do [feedback loops](feedback%20loops.md) play into these systems? Is it possible to create good human-in-the-loop ML?
...
Systemized classification and quantification of the world acts as an interpretive and transformational force. In other words, [quantization](quantization.md) changes the world.
...
Abridged maps as [potemkin villages](potemkin%20village.md), producing a simplified yet inaccurate view of the world. It's not necessarily wrong to create 'abridged maps', the problem comes when projecting the map onto the world to try and create change.
...
There's no dataset in the world that adequately conveys white supremacy, or slavery, or colonialism. (see: [data distributions](data%20distributions.md))
...
See also: [[map as territory](map%20as%20territory.md)

## Metis

James C. Scott in [[Seeing like a State|Seeing like a State](Seeing%20like%20a%20State.md) desribes _metis_, which he translates substantively as the intelligence required to adapt to new and changing circumstances.

Metis is more than constructing any number of "rules of thumb". Rather, knowing how and when to apply those rules in a concrete situtation is the essense of _metis_. Isn't _metis_ then just the [frame problem](frame%20problem.md)?

"A person without the lived experience of disabilities can never truly understand what it means to be 'like' someone who experiences it." [Disability simulation](Design%20Justice.md) doesn't work; why do we let ML systems do it then, let alone systems without _metis_?

Important in the context of [traditional knowledge (TK)](traditional%20knowledge.md)
