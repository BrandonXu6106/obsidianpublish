...
(see: data lensing in [idea list](idea%20list.md))

## Beyond Windows

[Source: Universal data portability by _Alexander Obenauer_](https://alexanderobenauer.com/labnotes/002/)

A modern day [HyperCard](https://en.wikipedia.org/wiki/HyperCard). What other types of [interaction design](interaction%20design.md) can we facilitate?
