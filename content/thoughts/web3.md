...
Of course, this is not perfect technology. I do have a few [hesitations/critiques](web3%20critique.md) on it as well.

## Index

- [Blockchain](blockchain.md)
- [Decentralization](decentralization.md)
- [Public Goods](public%20goods.md)
- [DAOs](dao.md)
- [Quadratic Funding](quadratic%20funding.md)
- [Proof of stake](proof%20of%20stake.md)
- [Proof of work](proof%20of%20work.md)
- [Consensus](consensus.md)
- [Play](content/recentnotes/play.md)
- [NFTs](NFT.md)
- [Arweave](Arweave.md)

Notes on [Kernel](https://kernel.community/en/) curriculum: [Kernel](Kernel%20Curriculum.md)
...
[Internet](Internet.md) services were built on open [protocols](Protocol.md) that were controlled by the internet community. Develops could generally rest assured that these protocols wouldn't change much because they were commonly agreed on by the community.

### Web2, Platform Economy [2000s to 2020s]

Internet as we know it today, companies that provide services in exchange for your personal data. Web2 enabled us to enjoy [P2P](peer-to-peer.md) interactions on a global scale, but always with a middleman: a platform acting as a trusted intermediary between two people who do not know or trust each other.
...
3. Fracturability: can happen when there are disagreements about [protocol](Protocol.md) changes
4. Cost: gas fees
