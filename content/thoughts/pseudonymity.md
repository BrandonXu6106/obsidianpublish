...
An identity-based [social graph](social%20graphs.md) is fundamentally limited. Your Facebook identity and social graph are mere digital shadows of their physical counterparts, and little more.
...
Is it possible to have pseudonymous identities in decentralized [web3](web3.md) systems? Or does it rely purely on natural human recognition of user handles? What about wallet addresses?
...
We can then use on-chain transactions to hypothesize and analyze possible affiiliations and cultural attitudes. For example, owning an [NFT](NFT.md) whose profits will go towards a charity may signal values similar to that charity/cause.
