...
2. [[ontology|Ontologically]]: the powerful constitute the social world
...
2. [[interdependence|Interdependence]]: epistemic resources are by nature collective
   ...
   2. Related: [[language|language]] and [terminology](terminology.md). Wittgenstein: "a language that in principle could be understood by only one person would not be a language at all"
