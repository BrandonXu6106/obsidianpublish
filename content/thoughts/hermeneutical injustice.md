...
Hermeneutics is the theory and methodology of interpretation. **Hermeneutical injustice** is a subcategory of [epistemic injustice](epistemic%20injustice.md) wherein one has no labels/common terminology to describe or explain experiences to others. Historically has been applied in the context of exclusion of marginalized groups from activities which shape the [[language.md|language]] we use.

[[identity.md|Identity]] affects experience, and experience makes a difference in our judgment.
...
2. [[ontology.md|Ontologically]]: the powerful constitute the social world
3. [Epistemologically](epistemology.md): the powerful have an unfair advantage in structuring collective social understandings
...
2. [[interdependence.md|Interdependence]]: epistemic resources are by nature collective
   ...
   2. Related: [[language.md|language]] and [terminology](terminology.md). Wittgenstein: "a language that in principle could be understood by only one person would not be a language at all"
...
The dominantly situated knower cannot step outside of her situatedness in order to experience the world as others do; however, she can learn to use epistemic resources developed from the experiences of marginalized knowers (same reason why [[Design Justice#Disability Simulation|disability simulation](Design%20Justice.md) doesn't work)
...
The marginalized knower possesses a sort of [double-consciousness](double-consciousness.md).
