...
The promise of the web is that Alexandria’s [library](library.md) might be resurrected for the modern world. But today’s great library is being destroyed even as it is being built. Until you lose something big on the [Internet](Internet.md), something truly valuable, this paradox can be difficult to understand.

"Ephemerality is built into the very architecture of the web, which was intended to be a messaging system, not a library." (maybe we need more [friction](friction.md)?)
...
Related: [Mangrove Theory of the Internet](Mangrove%20Theory%20of%20the%20Internet.md), [Dark Forest Theory of the Internet](Dark%20Forest%20Theory%20of%20the%20Internet.md)
