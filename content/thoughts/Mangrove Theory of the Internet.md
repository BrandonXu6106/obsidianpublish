...
Related: tools for [digital commons](digital%20commons.md)
...
How can we create mangroves? Garden/forest type ecosystems which have gently flowing multi-branched stream systems, designed for [digital mindfulness](digital%20mindfulness.md) and non-linearity?

Can we create different [pace layers](pace%20layers.md) for interaction?

Related: [ephemereal content](ephemereal%20content.md)
