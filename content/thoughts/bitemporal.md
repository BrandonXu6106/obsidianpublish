...
**Bitemporality** is a technique for modeling [[time|time]] in databases and data structures such that...

- The state at any point in history can be recovered
- Alternative timelines can be forked

It's basically time travel! Some [[Merkle-DAG|Merkle-DAGs]], if structured properly, can have this property
