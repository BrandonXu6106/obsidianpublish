...
> "To understand how AI is fundamentally [[Do Artifacts Have Politics|political](Do%20Artifacts%20Have%20Politics.md), we need to go beyond neural nets and statistical pattern recognition to instead ask _what_ is being optimized, and _for whom_, and _who_ gets to decide."
...
AI is an attempt to be _the_ atlas -- the dominant way of [[seeing.md|seeing]] the world. We should instead try to construct "humble geography" that acknowledges one's specific perspectives rather than claiming objectivity or mastery.
...
"It was the '[[move fast and break things](move%20fast%20and%20break%20things.md)' of a different time"
...
"Even the largest troves of data cannot escape the fundamental slippages that occur when an infinitely complex world is simplified and slices into categories." (see also: [[quantization.md]])
...
"This is the danger of affect recognition tools. As we've seen, they take us back to the phrenological past, where spurious claims were made, allowed to stand, and deployed to support existing systems of power." (again: [[observer-expectancy effect](observer-expectancy%20effect.md))
...
AI and algorithms create a false objectivity, "it's just math, math can't be biased, right?" -- where's the [accountability](accountability.md)? (see also: [[../posts/aigc/bias-bug.md|bias bug]])
