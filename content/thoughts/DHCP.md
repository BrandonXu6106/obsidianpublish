...
Dynamic Host Configuration [Protocol](Protocol.md) so they can join a network. Assigns [IP addresses](IP%20Address.md) to hosts. Main reason was when people started moving devices across networks
