...
1. [[consistency|Consistency]]: a system operates fully or not at all, all nodes agree (the system's behaviour is indistinguishable from a centralized system)
...
- ACID stands for atomicity, consistency, [[isolation|isolation]], durability
  - Prioritizes C and A
