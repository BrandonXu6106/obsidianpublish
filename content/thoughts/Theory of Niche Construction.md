...
Human capacities, cognitive and non-cognitive alike, turn out to depend on the fact that humans engineer their environment to support their activities (see: [[agency.md]])
...
Arguably, language and [terminology](terminology.md) are extended phenotypes
...
Inheritance is not strictly vertical, it can be oblique and many-to-one (information flow from many members of the parental generation — and from each other) (see: [[generational learning|intergenerational learning](generational%20learning.md))
...
See also: [[collective intelligence](collective%20intelligence.md)
