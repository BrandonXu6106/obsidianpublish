...
Example of an [[Ensemble method|Ensemble method](Ensemble%20method.md). They are non-parametric

They work by taking a vote from a set of deep [[decision tree|decision trees](decision%20tree.md). Two key ingredients to help ensure the deep decision trees make independent errors
