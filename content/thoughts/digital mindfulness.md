...
On methods to reclaim ourselves from the [attention economy](attention%20economy.md). How do we enable [friction](friction.md) to give people the space to think and reflect?
...
This is an opportunity for us to reclaim our attention, to _properly_ build out asynchronous experiences so that people can work in their own time rather than the rushed, [ephemereal content](ephemereal%20content.md) we're so used to now.
...
- How do we introduce temporality into objects to appreciate their inner processes?
  ...
  - Transit time between websites? (bring back [friction](friction.md))
...
- manifests change through time (big [_A Tale for the Time Being_](A%20Tale%20for%20the%20Time%20Being.md) energy)
...
> "There are also growing calls in the [HCI](human%20computer%20interaction.md) community to develop alternative approaches to designing interactions with personal data that better support experiences of contemplation, interpretation, and slowness"
...
- Blackspots emerging in one's digital history when devices and services breakdown
  - The result of [infrastructural](infrastructure.md) inversion
