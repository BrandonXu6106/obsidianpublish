...
- But, intentionality doesn't mean you can't change though. People aren't permanent, thoughts aren't permanent. Why should we try to make them so? (see: [[../posts/readnotes/me-myselves-and-i.md|meditation on change of self]])

## Dennet

Intentionality is based off of repeated behaviour rather than internal mechanisms. This accepts [Brentano](Brentano's%20Thesis.md)'s definition of the mental, but proposed [[Materialism.md|materialist]] way to view intentionality (and intelligence)

1.  Behaviour should be understood not in isolation but in [[context.md]] and as part of a consistent pattern of behaviour (holism)
2.  A consistent pattern of behaviour in context can be construed as [[rationality.md|rational]] (interpretation)
