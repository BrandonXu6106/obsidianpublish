...
![[images/Rhizome.png]]_How can we imagine more rhizomatic structures instead of arborescent systems?_
...
The competitive advantage of the vast majority of today’s centralized platforms are in their data moats and [[network effect|network effects](network%20effect.md). The major reason why these platforms remain so dominant is because of their data and users, not because of how good the service quality is.
...
I’m tentatively calling this project Rhizome. It aims to be a data-persistence and identity layer for the [[distributed web|distributed web](distributed%20web.md).
...
_This is a summarized version of the full vision of Rhizome. Read the full essay on [[../posts/branddesign/fonts/towards-data-neutrality.md|data neutrality]]._

## Technical Details

Rhizome is a set of abstractions on top of [[DID.md|DIDs]], [[UCAN.md|UCANs]], [[../posts/aigc/bft-json-crdt.md|BFT CRDTs]], and a [[RDF.md|tuple store]]. It is a local-first data replication and synchronization service much like iCloud/Dropbox.
...
- All application data is stored in the form of an EAV Tuple store. This is fully replicated between devices.
  ...
  - A public marketplace where people can buy and sell compute/storage. Reliability of service is ensured using a modified version of [[Filecoin.md|FileCoin]]'s [Proof of Replication](https://filecoin.io/blog/posts/what-sets-us-apart-filecoin-s-proof-system/)and providers can advertise storage/compute specification so purchasers can choose whether to optimize for space or performance.
- Users can collaborate with others by creating a [[UCAN.md]] which gives another user permission to read/write a portion of their data
  ...
  - This allows live collaboration both in asynchronous and synchronous modes (more notes on this in [[collaborative software](collaborative%20software.md))
...
- [Ceramic](https://blog.ceramic.network/what-is-ceramic/)
  ...
  - Use of DIDs is incredibly smart, potentially enabling [[Self-sovereign Identity (SSI)|self-sovereign identity](Self-sovereign%20Identity%20(SSI).md) down the line.
  - Doesn't seem to support multi-writer documents right out of the box, seems to be an ongoing area of work/research.
  - Great principles and solid work already. Seems to have gained some adoption from people in [[web3.md|web3]] already.
- [[Hypercore.md|Hypercore/Dat Protocol]]:
  - Extremely values aligned! Streaming based append-only log that aims to be the lego-block of distributed applications.
  - Great developer experience.
  - Use of [[DHT.md|DHT]] means that it doesn't need a signalling server for peer discovery.
  ...
  - [[Hypercore.md|Hypercore]] also does not guarantee long-term write-once storage.
...
- [[Raft Consensus Algorithm|Explainer on the Raft Consensus Algorithm](Raft%20Consensus%20Algorithm.md)
- Explainer on [[../posts/aigc/bft-json-crdt.md|BFT CRDTs]]
- Modelling distributed systems
  - [<1kloc Raft Implementation](https://github.com/jackyzha0/miniraft)
- [[../posts/aigc/digital-identity.md|From legibility to identity]]
- [[../posts/aigc/agentic-computing.md|LAN the Internet Again]]
- ...more to come

---

You can find the ongoing [[Rhizome Research Log|research log here](Rhizome%20Research%20Log.md).
