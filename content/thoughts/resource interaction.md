...
Interactions arise naturally from the affordances of resources or are purposefully designed into [organizing systems](organizing%20system.md). Intersects with [interaction design](interaction%20design.md)
...
One approach to resource transformation is to use a _crosswalk_ or [[boundary object](boundary%20object.md) which are equivalence tables that relate resources from one organizing system to another
