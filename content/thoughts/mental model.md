...
It is an inner [representation](representation.md) of a system.

2 types:

1. Internal frameworks: about the mental process inside user's head
2. External frameworks: account for interactions with technologies, environment, and [context](context.md)
...
- [conceptual model](conceptual%20model.md): something the **designer creates**
