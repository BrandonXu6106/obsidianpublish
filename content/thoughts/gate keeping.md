...
- Platforms gate keep by managing [information](information.md) flows in many different ways
- Non-human agents participate through algorithmic filtering (e.g. upvoting content)
- See centralization of [Internet](Internet.md) through search

## Differences from [censorship](censorship.md)
...
- Bozdag (2013): personalization leads to more [bias](bias.md) rather than less
