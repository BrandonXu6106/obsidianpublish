...
The same reason why we should look at [terminology](terminology.md) and _why_ words with historical [context](context.md) came to be (e.g. [new words](../posts/readnotes/new-words.md))
...
Similarly: [Lindy effect](Lindy%20effect.md)
