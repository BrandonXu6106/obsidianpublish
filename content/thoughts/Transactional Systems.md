...
- It validates transactions: enforces [[concurrency control|concurrency control](concurrency%20control.md), or more rarely, domain-specific semantics.
...
See also: [[distributed atomic transaction|distributed atomic transaction](distributed%20atomic%20transaction.md)