...
Wouldn't this favour the rich? Well yes, but we can mitigate this by using weighting like [quadratic voting/funding](quadratic%20funding.md) which values number of unique contributions more than dollar amounts.
...
The question applied to [web3](web3.md): **can we advance the aims of rehabilitative justice using a shared and common historical record for better [accountability](accountability.md)?**

## Engineering Money

> Money-as-a-[protocol](Protocol.md) really allows us to do is program incentives at scales never before possible
...
However, it feels liek we run into a weird [catch 22](catch%2022.md) here where it is debatable whether the new 'engineered money' actually does have the properties we claim to have so it holds us back from developing/accepting it any more. I think this is in large part due to money being a combination of both **technical protocols and [social contracts](social%20contracts.md)**
