...
Mechanism design asks how one can design systems so that agents’ selfish behavior results in the desired system-wide goals (similar to [[incentives.md|incentive]] design and [[economics.md]])
...
Mechanisms in which agents are asked to directly reveal their [[utility.md|utility]] functions are call direct mechanisms
...
See: [[game theory](game%20theory.md), [[economics.md]]
