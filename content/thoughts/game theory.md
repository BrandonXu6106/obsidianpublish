...
2. Possible win-win situations. This must be a [positive sum](positive%20sum.md) game where _both_ players can be better off
...
Game theory feels hard to apply to the real world due to properties like the [Collingridge Dilemma](catch%2022.md)

Games, however, are a great test bed for a lot of game theory given how information rich they are. See [game design](game%20design.md)
