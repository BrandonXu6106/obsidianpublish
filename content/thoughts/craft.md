...
My (considerably longer) list of unfinished ideas can be found [here](idea%20list.md). You can also find a list of things that didn't quite go so well in my [[../posts/readnotes/a-failure-resume.md|failure resume]].
...
- Pluriverse (2022)
	- Website for Verses' Pluriverse Project. This site stands as an artifact to foster collective dialogue centered around [[plurality.md|pluralism]].
...
- **ruspty** (2024)
	- Wrote large chunks of the core library code in Rust which allows consumers in Node.js and Bun to create [[terminal.md|pseudoterminal]] file descriptors for forked processes.
...
- **bft-json-crdt** -- the first JSON-like Byzantine Fault Tolerant CRDT (2022)
	- A simplified Automerge-like [[CRDT.md|CRDT]] in Rust with ideas from Martin Kleppmann's 2022 paper on _Making CRDTs Byzantine Fault Tolerant_. The blog post also [hit #3 on Hacker News](https://news.ycombinator.com/item?id=33694568) the day it was released and has been [featured in go-to resources for CRDTs](https://crdt.tech/).
	- Source: [GitHub](https://github.com/jackyzha0/bft-json-crdt), [[../posts/aigc/bft-json-crdt.md|blog post]]
	- ![[images/bft-json-crdt.png]]
- Distributed Press -- publishing websites to the [[distributed web|distributed web](distributed%20web.md) (2022)
...
- Tabspace -- a scratchspace for your new tab page (2022)
	- A new tab replacement that gives you your very own scratch space to help you stay organized and focused. Wanted to experiment with [[formality considered harmful|low-friction](formality%20considered%20harmful.md) note taking and integrating [[game design|game design](game%20design.md) principles of 'juiciness' into UI/UX.
...
- miniraft -- <1kloc Raft consensus algorithm implementation (2022)
	- A minimal implementation of the [[Raft Consensus Algorithm|Raft Consensus Algorithm](Raft%20Consensus%20Algorithm.md) in Rust with a focus on readability/understandability. This project was created as an exercise in implementing and learning about distributed systems.
...
- Telescopic Text -- open source library for expandable text (2022)
	...
	- I've been thinking a lot about creating a browsable store of knowledge that provides something useful at all distance scales and concepts like Telescopic Text are a first step in creating more [[information scales|information scales](information%20scales.md) than just a single document level.
...
- Portal -- zero-config [P2P](peer-to-peer.md) encrypted folder syncing (2021)
	- A command line tool that syncs folders between multiple devices without a central server. Built on top of the [[Hypercore.md|Hypercore]] protocol.
...
-  ctrl-v -- a modern, open-source pastebin (2021)
	- Source: [App](https://ctrl-v.app/), [GitHub](https://github.com/jackyzha0/ctrl-v), [[ctrlv-next.md|blog post]]
	- ![[images/ctrl-v.png]]
...
- reflect -- a mindful website blocker for the productive (2020)
	...
	- Source: [Site](https://getreflect.app/), [GitHub](https://github.com/jackyzha0/reflect-chrome), [[reflect.md|blog post]]
...
- Kernel Issue 2: Open Source and Politics (2022)
	- A conversation with Coraline Ada Ehmke on the [[software and politics|politics of open source software](software%20and%20politics.md).
	- Links: [original](https://www.kernelmag.io/2/open-source-politics), [[../posts/readnotes/open-source-and-politics.md|full text]]
	- ![[images/kernel-2.png]]
- Reboot: Towards Data Neutrality (2022)
	...
	- Links: [original](https://joinreboot.org/p/rhizome), [[../posts/branddesign/fonts/towards-data-neutrality.md|full text]]
...
- [Playspace](http://playspace.club/) (2024-2025)
	...
	- See also, our [[Playspace.md#Retro Notes|retro log]]
	- ![[images/playspace.png]]
- Saturdays (2023)
	- Weekly co-working sessions at UBC inspired by [Socratica](https://www.socratica.info/).
	- ![[images/saturdays.png]]
- [nwPlus](https://nwplus.io/) (2019-2023)
	...
	- I left after graduating with strong opinions on [[../posts/aigc/hackathons.md|hackathon culture]] and where to go from there.
	- ![[images/nwhacks.png]]

## Speaking

- Let us imagine a communally-owned internet! at DWeb Camp (2023)
	- ![[images/dweb-collage.png]]
- Communal Computing Networks at DWeb YVR (2023)
	- ![[images/dweb-yvr.png]]
- Intro to Computer Networking & P2P at Hack the North (2022)
	- ![[images/htn22-talk.png]]
...
- [Intro to Docker at Hack the North 2020++](https://www.youtube.com/watch?v=ONNQ5EDhXUk) (2021)
	- ![[images/docker-workshop.png]]


## Physical

- Ceramics (2023-)
	- I'm trying to make [[50 pounds of pots|50 pounds of pots](50%20pounds%20of%20pots.md) in an effort to hone my craft.
	- ![[images/pottery.png]]
