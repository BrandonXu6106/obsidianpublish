...
![[images/hyperscope.png|300]]

## Semantic Zoom
[Source](https://alexanderobenauer.com/labnotes/038/)

Our field of view (or [[context.md|context]]) on all of that data is defined by the interfaces we use. Rigid, pre-packaged interfaces don’t let us move our field of view around, should we wish to get a different vantage point on some data we care about.
