...
Large Language Models (LLMs) are [[autoregressive model|autoregressive](autoregressive%20model.md) foundational machine learning models that use [[machine learning](machine%20learning.md) to process and [[NLP.md|understand natural language]]. They seem to have [[emergent behaviour|emergent properties](emergent%20behaviour.md) of [[intelligence.md]], though this could just be the [[observer-expectancy effect](observer-expectancy%20effect.md)

See also: [[transformers.md]]

## Teaching

The widespread use of ChatGPT poses a [[teaching.md|pedagogical question]]: how do we assess thinking?
...
Don't shit where you eat! [[garbage in garbage out|Garbage in garbage out](garbage%20in%20garbage%20out.md)! When it comes time to train GPTx it risks drinking from a dry riverbed.

Maggie Appleton calls this 'human centipede [[epistemology.md]]': models are trained on generated content and ideas lose provenance. "Truth" loses contact with reality and degrades even more.
...
I don't think it's ready to replace anything that requires rigorous thought or reasoning quite yet because it is still very prone to confidently hallucinating wrong answers. LLMs should acts as an atlas and not a map (see: [[plurality.md]])

## End-user programming

See also: [[cozy software|personal software](cozy%20software.md)
