...
Additionally, energy consumption [[causal decision theory#Granger Causality|Granger-causes]] real GDP per capita and vice versa in the long run, which implies that an increase in energy consumption leads to an increase in economic growth and vice versa.
...
## Ergopobia
Excerpt from [[Where is My Flying Car|Where is My Flying Car]]:
...
See also:  [[Mass Hysteria|Mass Hysteria]] (re: fearmongering around [[Nuclear Fusion|nuclear]])