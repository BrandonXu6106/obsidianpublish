...
![[UCAN hierarchy.png](images/UCAN%20hierarchy.png)
...
>
> from [[Bluesky.md|Bluesky's ADX]]

Since anything with a private-public keypair can generate a [[DID.md]], UCANs can be an auth layer that **naturally plugs into existing identity primitives and services**
