...
Domain name: an identification string that defines a realm of administrative autonomy, authority, or control within the [Internet](Internet.md).
...
How do we resolve domain names to [IP addresses](IP%20Address.md)? Resolves starting from the root and makes it way down the network hierarchy
