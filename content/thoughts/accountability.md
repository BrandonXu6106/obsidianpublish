...
Also note that the emotional labour that goes into holding a group accountable goes up in a democratic setting when more people are involved (see also: [group limits](group%20limits.md)). Is there a point where it is almost always better to have an authoritarian/impersonal third party? (e.g. the state and the law)
