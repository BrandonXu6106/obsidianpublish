...
Hypercore Protocol is a [[peer-to-peer.md|peer-to-peer]] data network built on the Hypercore logs. Hypercores are signed, append-only logs. They're like lightweight blockchains without the [[consensus.md|consensus]] algorithm

Connects peers using the Hyperswarm [[DHT.md|DHT]] which is based off of [[Kademlia DHT|Kademlia](Kademlia%20DHT.md)
...
- [[../../..//content/thoughts/Hypercore.md|Hypercore]] also does not guarantee long-term write-once storage
