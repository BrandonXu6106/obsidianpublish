...
Hypercore Protocol is a [[peer-to-peer|peer-to-peer]] data network built on the Hypercore logs. Hypercores are signed, append-only logs. They're like lightweight blockchains without the [[consensus|consensus]] algorithm

Connects peers using the Hyperswarm [[DHT|DHT]] which is based off of [[Kademlia DHT|Kademlia]]
