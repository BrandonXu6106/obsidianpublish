...
In contrast to client-server models, peer-to-peer systems are [[decentralization.md|decentralized]] [[Network Theory|networks](Network%20Theory.md) with no privileged nodes. Each node performs the same roles as any other.

A philosophically [[plurality.md|pluralistic]] way of computing that recognizes there isn't only one correct primary site (see: [[A Certain Tendency Of The Database Community](A%20Certain%20Tendency%20Of%20The%20Database%20Community.md)).

Examples include [[BitTorrent.md|BitTorrent]], [[blockchain.md|blockchains]], [[Rhizome Proposal|Rhizome](Rhizome%20Proposal.md)
...
- Limitations of Operation logs
  ...
  - Overall, unsolved. All of this together leads to either a [[inevitability of centralization|centralization](inevitability%20of%20centralization.md) of power in long-lived nodes that do the replication for you due to preferential attachment
...
- Mauve suggests that we can actually solve these using [[Prolly Trees](Prolly%20Trees.md)
