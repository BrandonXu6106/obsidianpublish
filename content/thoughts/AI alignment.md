...
How do we get [[agi|AI systems]] to align with real human [[social contracts|social contracts and values]]? Or, in more mathematical terms, how do we make [[quantization|legible]] our soft and squishy human values into hard mathematical formula and policy?
...
- RLHF: [Summarization from human feedback](https://openai.com/blog/learning-to-summarize-with-human-feedback/) was really the first convincing proof-of-concept that RLHF works on language models and that you can optimize goals that are fuzzy and somewhat ambiguous.
  - How do we optimize for goals that are not easily [[quantization|quantizable]]?
