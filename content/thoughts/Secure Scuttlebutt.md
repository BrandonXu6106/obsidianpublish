...
Secure Scuttlebutt is a database protocol for unforgeable (read: [[digital signatures|digitally signed]]) append-only message feeds.
...
Web-of-Trust style (see: [[Public-key Infrastructure#PGP|PGP]]). There is no global registry of usernames. Instead, users name themselves, and share [[petname|petnames]] for each other.
