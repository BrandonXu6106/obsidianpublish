...
[[system model|System models]] for programming.

## Technical Dimensions of Programming Systems

[Source](https://tomasp.net/techdims/)

![[content/recentnotes/images/tech-dims.png|500]]
...
1. Interaction: how do users manifest their ideas, use the system to get a result, and generate new ideas in response?
   ...
   - See also: [[mental model]], [[feedback loops#Interaction Design|feedback loops in interaction design]]
...
3. Conceptual structure: how do the parts fit together?
   - [[composable|Composability]]: There exist building blocks which span a range of useful combinations. Composability is, in a sense, key to the notion of "programmability" and every programmable system will have some level of composability
   ...
   - Conceptual openness: can be seen as championing the values of *[[plurality|pluralism]]*, *compatibility*, or *conceptual openness* over conceptual integrity
   - See also: [[Gall's law]]
...
5. [[complexity|Complexity]]: how does the system structure complexity and what level of detail is required?
   ...
   - Declarative vs imperative programming systems
     - [[declarative programming|Declarative programming]] systems like SQL, Prolog or Datalog, the meaning of a program is still unambiguous, but it is not defined operationally—there is a (more or less deterministic) inference engine that solves the problem based on the provided description.
...
6. Errors: what does the system consider to be an error? How are they prevented and handled?
   ...
   - Normally, error detection occurs in the feedback loops that the system implements.
     ...
     - How does the system respond when an error is detected?
       - The system may try to automatically recover from the error as best as possible ([[CRDT|CRDTs]] take this approach)
       - The system may proceed as if the error did not happen
       - The system may ask a human to resolve the issue. This is common for errors that occur on a [[semantics|semantic]] level
