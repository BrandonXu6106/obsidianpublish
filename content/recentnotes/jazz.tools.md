...
Embodies the principles of [[local-first software|local-first software]]

Components

1. `cojson`: A collaborative JSON type
2. State synchronization and persistence
3. Cryptographic [[access control|access control]]
4. Global mesh: smart routing transport layer for p2p data. With [[encryption|encryption]]!
