...
My (considerably longer) list of unfinished ideas can be found [here](idea%20list.md). You can also find a list of things that didn't quite go so well in my [[a-failure-resume|failure resume]].
...
- Community Lock Screen Collage, digital installation for [Kernel 4](https://www.kernelmag.io/issues/4) Launch Party (2024)
	...
	- ![[content/recentnotes/images/lockscreen-collage.png]]
...
- Pluriverse (2022)
	- Website for Verses' Pluriverse Project. This site stands as an artifact to foster collective dialogue centered around [[plurality|pluralism]].
...
- **ruspty** (2024)
	- Wrote large chunks of the core library code in Rust which allows consumers in Node.js and Bun to create [[terminal|pseudoterminal]] file descriptors for forked processes.
	...
	- ![[content/recentnotes/images/shell-comparison.png]]
- **River** (2023)
...
- **bft-json-crdt** -- the first JSON-like Byzantine Fault Tolerant CRDT (2022)
	- A simplified Automerge-like [[CRDT|CRDT]] in Rust with ideas from Martin Kleppmann's 2022 paper on _Making CRDTs Byzantine Fault Tolerant_. The blog post also [hit #3 on Hacker News](https://news.ycombinator.com/item?id=33694568) the day it was released and has been [featured in go-to resources for CRDTs](https://crdt.tech/).
	- Source: [GitHub](https://github.com/jackyzha0/bft-json-crdt), [[bft-json-crdt|blog post]]
	- ![[content/recentnotes/images/bft-json-crdt.png]]
- Distributed Press -- publishing websites to the [[distributed web|distributed web]] (2022)
...
- Tabspace -- a scratchspace for your new tab page (2022)
	- A new tab replacement that gives you your very own scratch space to help you stay organized and focused. Wanted to experiment with [[formality considered harmful|low-friction]] note taking and integrating [[game design|game design]] principles of 'juiciness' into UI/UX.
...
- miniraft -- <1kloc Raft consensus algorithm implementation (2022)
	- A minimal implementation of the [[Raft Consensus Algorithm|Raft Consensus Algorithm]] in Rust with a focus on readability/understandability. This project was created as an exercise in implementing and learning about distributed systems.
	- Source: [GitHub](https://github.com/jackyzha0/miniraft), [Documentation](https://jzhao.xyz/miniraft/miniraft/)
	- ![[content/recentnotes/images/miniraft.png]]
- Cursor Chat -- open source library for digital presence (2022)
	- A lightweight (31.8kB) cursor chat à la Figma for digital co-existing + presence. An experiment in spatial software, [interaction design](interaction%20design.md), and [digital commons](digital%20commons.md). Built on top of [yjs](https://github.com/yjs/yjs) and [perfect-cursors](https://github.com/steveruizok/perfect-cursors).
...
- Telescopic Text -- open source library for expandable text (2022)
	...
	- I've been thinking a lot about creating a browsable store of knowledge that provides something useful at all distance scales and concepts like Telescopic Text are a first step in creating more [[information scales|information scales]] than just a single document level.
...
- Portal -- zero-config [P2P](peer-to-peer.md) encrypted folder syncing (2021)
	- A command line tool that syncs folders between multiple devices without a central server. Built on top of the [[Hypercore|Hypercore]] protocol.
...
- Legist -- a platform to summarize policy for [democracy](democracy.md) (2021)
...
-  ctrl-v -- a modern, open-source pastebin (2021)
	- Source: [App](https://ctrl-v.app/), [GitHub](https://github.com/jackyzha0/ctrl-v), [[ctrlv-next|blog post]]
	- ![[content/recentnotes/images/ctrl-v.png]]
...
- reflect -- a mindful website blocker for the productive (2020)
	...
	- Source: [Site](https://getreflect.app/), [GitHub](https://github.com/jackyzha0/reflect-chrome), [[reflect|blog post]]
...
- Speech2Braille -- a wearable device to transcribe speech (2018)
	...
	- ![[content/recentnotes/images/speech2braille.png]]
...
- Kernel Issue 2: Open Source and Politics (2022)
	- A conversation with Coraline Ada Ehmke on the [[software and politics|politics of open source software]].
	- Links: [original](https://www.kernelmag.io/2/open-source-politics), [[open-source-and-politics|full text]]
	- ![[content/recentnotes/images/kernel-2.png]]
- Reboot: Towards Data Neutrality (2022)
	...
	- Links: [original](https://joinreboot.org/p/rhizome), [[towards-data-neutrality|full text]]
...
- [Playspace](http://playspace.club/) (2024-2025)
	...
	- See also, our [[Playspace#Retro Notes|retro log]]
	- ![[content/recentnotes/images/playspace.png]]
- Saturdays (2023)
	- Weekly co-working sessions at UBC inspired by [Socratica](https://www.socratica.info/).
	- ![[content/recentnotes/images/saturdays.png]]
- [nwPlus](https://nwplus.io/) (2019-2023)
	...
	- I left after graduating with strong opinions on [[content/designnotes/hackathons|hackathon culture]] and where to go from there.
	- ![[content/recentnotes/images/nwhacks.png]]

## Speaking

- Let us imagine a communally-owned internet! at DWeb Camp (2023)
	- ![[content/recentnotes/images/dweb-collage.png]]
- Communal Computing Networks at DWeb YVR (2023)
	- ![[content/recentnotes/images/dweb-yvr.png]]
- Intro to Computer Networking & P2P at Hack the North (2022)
	- ![[content/recentnotes/images/htn22-talk.png]]
...
- [Intro to Docker at Hack the North 2020++](https://www.youtube.com/watch?v=ONNQ5EDhXUk) (2021)
	- ![[content/recentnotes/images/docker-workshop.png]]


## Physical

- Ceramics (2023-)
	- I'm trying to make [[50 pounds of pots|50 pounds of pots]] in an effort to hone my craft.
	- ![[content/recentnotes/images/pottery.png]]
