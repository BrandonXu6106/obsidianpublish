...
Layer 3, the layer below the [Transport Layer](Transport%20Layer.md) and layer above the [Link Layer](Link%20Layer.md)
...
1. [IP Address](IP%20Address.md): the one they are advertising they can reach
...
- Tier 2 Networks
  - A network that peers for free with some networks, but still purchases IP transit or pays for peering to reach at least some portion of the [Internet](Internet.md)
- Tier 3 Networks
