...
Moving Castles should reflect the following principles (adapted from the [design goals](design%20goals.md) described in [Modular Politics](https://arxiv.org/abs/2005.13701))
...
Programming is magic, and it's too powerful. There is no OS for the [Internet](Internet.md) telling you what you can and cannot do (only limitation is not running out of memory and time).
