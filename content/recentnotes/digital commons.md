...
How might we analogize [urban planning](urban%20planning.md) to social media and digital spaces?
...
2. There might even be different seasons of [play](content/recentnotes/play.md): periods of divergent planting and nurturing followed by collective harvesting and pruning (see: [exploit explore](exploit%20explore.md))
...
Are there any spaces that don't have ulterior motives and are just places of gathering? The only example that comes to mind where 'coincidental' interaction happen is within currated [interest groups](social%20graphs.md) like online network forums around [games](games.md) or technologies or early communities lead by superconnectors like the [Whole Earth 'Lectronic Link (WELL)](From%20Counterculture%20to%20Cyberculture.md). How can we recreate these public 'watering holes' for people to gather around?
...
So many of our mediums have now tended towards [real time](ephemereal%20content.md) in an effort to replicate the fleeting nature of face-to-face conversation; vanishing messages, video chats, and audio rooms. Yet, rarely do any of these platforms leave any indication whether a conversation ever happened between two people.
...
- Newsletters and personal sites -> Public places of exploration and self-identity, self-owned corners of the [internet](Internet.md)
...
- Almost all of these mediums are on a sliding scale of how '[real-time](ephemereal%20content.md)' the medium is, yet none of them are obsolete. Why is that?
