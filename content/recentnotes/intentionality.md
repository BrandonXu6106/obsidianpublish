...
- But, intentionality doesn't mean you can't change though. People aren't permanent, thoughts aren't permanent. Why should we try to make them so? (see: [[me-myselves-and-i|meditation on change of self]])

## Dennet

Intentionality is based off of repeated behaviour rather than internal mechanisms. This accepts [Brentano](Brentano's%20Thesis.md)'s definition of the mental, but proposed [[Materialism|materialist]] way to view intentionality (and intelligence)

1.  Behaviour should be understood not in isolation but in [[context]] and as part of a consistent pattern of behaviour (holism)
2.  A consistent pattern of behaviour in context can be construed as [[rationality|rational]] (interpretation)
