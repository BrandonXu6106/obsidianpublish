...
Well-built worlds enable _new stories_. [Games](games.md) and [fiction](fiction.md) are forms of worldbuilding (or 'worlding' as Cheng says), but not the only ones
...
Relationships, [friendships, and love](friendship.md) are all forms of Worlding
...
3. The [Hacker](Hackers.md): pushes the boundaries of the World, using exploration and 'meaningless' [play](content/recentnotes/play.md)
...
- the world seed
  ...
  - "All [games](games.md) using The Seed as their game engine allow conversion of one account in a Seed-based world to another.
- infrastructure that operates at different [pace layers](pace%20layers.md)
