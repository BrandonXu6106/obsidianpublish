...
The post-WWII 'information explosion' meant that we have a lot of info and not great means of looking through it to find what we want. This is a form of [information retrieval](information%20retrieval.md) and way of answering [questions](questions.md).
...
Search is a form of [recommendation system](recommendation%20system.md)

Essay on [Bias in Search](Bias%20in%20Search.md)

### Queries on [information](information.md)
...
When you monetize via ads, curation takes a backseat to featuring advertisers - there is just less digital real estate available to curate your own recommendations. This creates [trust](trust.md) gaps between users and search engines.
...
Curation, when thought of in the context of sharing bite-sized, isolated bits in feed-like architectures, is predominantly about entertainment, not utility. **How do we move beyond the search bar in an [attention economy](attention%20economy.md)?**
...
![[content/recentnotes/images/internet-atlas.png|600]]
...
See also: [internet computing](internet%20computing.md), [Internet](Internet.md)
...
Is this a form of [hermeneutical injustice](hermeneutical%20injustice.md)?

1. Lexical Ambiguity: the [meaning](meaning.md) of human language is not specific
2. Polysemy: one word has many meanings
3. Synonymy: many words mean approximately the same thing

### Text Processing

Similar to practices in [reflect](reflect.md) NLP processing actually!
