...
Related: [Tribe flourishing](tribe%20flourishing.md)
...
1. False Belief Requirement
   ...
   - Knowledge as justified true belief or JTB (see [Knowledge Argument](Knowledge%20Argument.md)): $S$ believes that $p$, $S$ is justified in believing that $p$, and $p$ is true
...
![[content/recentnotes/images/let-july-be-july.png|400]]
