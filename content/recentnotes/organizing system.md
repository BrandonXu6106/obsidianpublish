...
_Organizing System_: an [intentionally](intentional%20arrangement.md) arranged collection of resources and the interactions they support. It has authoritative description and standard classification.
...
Similar to [research debt](research%20debt.md) where there is no effort put into the initial organizational process so the mental burden of retrieving information is much higher.
...
Similar to the questions in the HCI [design requirements](design%20requirements.md). When designing an organizing system, it is important to consider domain, scope, and scale.
...
This scoping process is similar to the [double-diamond design](design%20requirements.md) in [HCI](human%20computer%20interaction.md).
...
Mostly made popular by efficiency, exploitation of gendered labour, anxiety over information loss, and granular certainty (wanting to break more and more of life into discrete, [quantized, and labelled](quantization.md) parts)

[Information](information.md) then, was seen as something that could be standardized atomized, and stripped of context.
