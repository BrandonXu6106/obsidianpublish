...
[Money](money.md) is power. It dictates what type of research and work gets [funded](funding.md), and who gets to do it.
...
- Not as much funding of [public goods](public%20goods.md). Arguably, "predicting future public goods is as important a social function as predicting future private goods"
...
Some thoughts. Already have been thinking about this in relation to [hackathons](content/designnotes/hackathons.md), [paid open source](paid-open-source.md)

## 3rd Spaces

For people wanting to create change, why do we choose to do that through innovation rather than policy? (is this due to [creation vs maintenance](creation%20vs%20maintenance.md) approaches to thinking?)
...
Related: reinventing [hackathons](content/designnotes/hackathons.md) as 3rd spaces
...
"Instead, I believe that the most promising way to achieve large-scale improvement in the way basic scientific research is organized is to start small, help individual scientists, and to make [small steps towards a much better world](https://marginalrevolution.com/)." Is this potentially good justification for [minigrants](idea%20list.md)?
