...
Related: [Moderation](Moderation.md)
...
- Secluded vs public: [digital commons](digital%20commons.md)
...
- Screen for value alignment
  ...
  - Resonance with a large body of [[content/recentnotes/writing]]
...
![[content/recentnotes/images/online-governance-regimes.png|500]]
...
1. Techno Utopia trap
   - an attempt 'to build it better' from tabula rasa (very ['move fast and break things'](move%20fast%20and%20break%20things.md))
...
- "Auctioning off or loaning away voting power to those uninvested in quality governance, or want to steer governance towards selfish ends misaligned with the community, is generally a terrible idea." (see: [Plato's Ship of State](Plato's%20Ship%20of%20State.md))
