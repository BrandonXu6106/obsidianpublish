...
A [[CRDT|CRDT]] + [[Operational Transform|OT]] text editing algorithm with history pruning (read: GC). Permissionless [[system model]].
...
- Blooping: collapsing history. This is kind of like span-merging which [[Yjs]] implements
  ...
  - ![[content/recentnotes/images/antimatter-bloop.png|400]]
