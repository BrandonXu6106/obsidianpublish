...
- It validates transactions: enforces [[concurrency control|concurrency control]], or more rarely, domain-specific semantics.
...
See also: [[distributed atomic transaction|distributed atomic transaction]]