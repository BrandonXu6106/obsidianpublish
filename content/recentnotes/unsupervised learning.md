...
In [[supervised learning|supervised learning]], we have features $x_i$ and class labels $y_i$. Write a program that produces $y_i$ form $x_i$

In **unsupervised learning**, we only have $x_i$ values, but no explicit target labels. We can

- [[outlier detection|Outlier detection]]: is this a normal $x_i$?
- Similarity/[[clustering|Clustering]]: which examples look like this $x_i$
