...
Both network and [transport layer](Transport%20Layer.md) (violation of abstraction/layering) More devices than [IP addresses](IP%20Address.md)! What do we do?
...
![](content/recentnotes/images/NAT.jpeg)
...
![[content/recentnotes/images/NAT-firewall-share.png]]

![[content/recentnotes/images/NAT-firewall-connection-rates.png]]
...
1. A and B both begin a [UDP](UDP.md) conversation with $S$
