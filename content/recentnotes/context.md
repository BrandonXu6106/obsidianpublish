...
In relation to the [Internet](Internet.md): our browsing is also very static and in a small window. By default, you can only browse on a page-level scale. What about subdomains? Apex domains (see more in [DNS](DNS.md))? How do we expand the aperture of the web browser to encompass more [information scales](information%20scales.md)? (potential [idea](idea%20list.md))
