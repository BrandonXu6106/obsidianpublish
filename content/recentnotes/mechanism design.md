...
Mechanism design asks how one can design systems so that agents’ selfish behavior results in the desired system-wide goals (similar to [[incentives|incentive]] design and [[economics]])
...
Mechanisms in which agents are asked to directly reveal their [[utility|utility]] functions are call direct mechanisms
