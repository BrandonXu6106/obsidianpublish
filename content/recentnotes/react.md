...
![Turning HTML into the DOM and then into the actual site](content/recentnotes/images/react/html-dom-site.png)_Turning HTML into the DOM and then into the actual site_
...
![React's Virtual DOM in action. ReactDOM.render() tells React to attach your React components to the real DOM](content/recentnotes/images/react/virtual-DOM.png)_React's Virtual DOM in action. ReactDOM.render() tells React to attach your React components to the real DOM_
...
![What if you wanted to reuse this 'product card' component?](content/recentnotes/images/react/component-reuse.png)_What if you wanted to reuse this 'product card' component?_
...
![React Component Diagram](content/recentnotes/images/react/component-diagram.png)_React Component Diagram_
...
![React Component Lifecycle](content/recentnotes/images/react/lifecycle.png)_React Component Lifecycle_
...
![Our todo app with a strikethrough effect!](content/recentnotes/images/react/todo-0.png)_Our todo app with a strikethrough effect!_
...
![A nice new 'Add Todo' field!](content/recentnotes/images/react/todo-1.png)_A nice new 'Add Todo' field!_
...
![Our working todo tracker!](content/recentnotes/images/react/todo-fin.gif)_Our working todo tracker!_
