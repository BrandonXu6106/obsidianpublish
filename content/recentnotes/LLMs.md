...
Large Language Models (LLMs) are [[autoregressive model|autoregressive]] foundational machine learning models that use [[machine learning]] to process and [[NLP|understand natural language]]. They seem to have [[emergent behaviour|emergent properties]] of [[intelligence]], though this could just be the [[observer-expectancy effect]]

See also: [[transformers]]

## Teaching

The widespread use of ChatGPT poses a [[teaching|pedagogical question]]: how do we assess thinking?
...
We do math by hand to help internalize it in our minds, to naturalize and practice the mind to thinking in that manner. Similarly, we [[content/recentnotes/writing|write]] to naturalize the mind to critical and thorough thought.
...
Don't shit where you eat! [[garbage in garbage out|Garbage in garbage out]]! When it comes time to train GPTx it risks drinking from a dry riverbed.
...
See also: [[cozy software|personal software]]
