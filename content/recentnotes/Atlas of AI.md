...
> "To understand how AI is fundamentally [[Do Artifacts Have Politics|political]], we need to go beyond neural nets and statistical pattern recognition to instead ask _what_ is being optimized, and _for whom_, and _who_ gets to decide."
...
AI is an attempt to be _the_ atlas -- the dominant way of [[seeing|seeing]] the world. We should instead try to construct "humble geography" that acknowledges one's specific perspectives rather than claiming objectivity or mastery.
...
AI and algorithms create a false objectivity, "it's just math, math can't be biased, right?" -- where's the [accountability](accountability.md)? (see also: [[bias-bug|bias bug]])
